 ...
 */
public class BrandPlistAdapter extends BaseAdapter implements View.OnClickListener {
    private static final String TAG = "HotProductAdapter";
    private BrandPlistResponse brandPlistResponse;
    private Context context;
    /**
     * 被点击商品详细信息的javaBean
     */
    private BrandPlistResponse.ProductlistBean currentProductlistBean;

    public BrandPlistAdapter(BrandPlistResponse brandPlistResponse, Context context) {
        this.brandPlistResponse = brandPlistResponse;
        this.context = context;
    }

    @Override
    public int getCount() {
        return brandPlistResponse.getProductlist().size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        currentProductlistBean = brandPlistResponse.getProductlist().get(position);
