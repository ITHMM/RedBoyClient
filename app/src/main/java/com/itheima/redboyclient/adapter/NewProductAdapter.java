...
import com.itheima.redboyclient.fragment.NewProductFragment;
 ...
 */
public class NewProductAdapter extends BaseAdapter implements View.OnClickListener {
    private static final String TAG = "NewProductAdapter";
    private NewProductResponse newProductResponse;
    private Context context;
    /**
     * 跳转下一个Fragment需要用的FragmentManager
     */
    private FragmentManager mFragmentManager;
    /**
     * 跳转下一个Fragment需要隐藏的当前Fragment
     */
    private NewProductFragment mNewProductFragment;

    public NewProductAdapter(NewProductResponse newProductResponse, Context context, FragmentManager fragmentManager, NewProductFragment newProductFragment) {
        this.newProductResponse = newProductResponse;
        this.context = context;
        this.mFragmentManager = fragmentManager;
        this.mNewProductFragment = newProductFragment;
    }

    @Override
    public int getCount() {
        return newProductResponse.getProductlist().size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NewProductResponse.ProductlistBean productListBean = newProductResponse.getProductlist().get(position);
    ...
    public void onClick(View v) {
        ...
        NewProductResponse.ProductlistBean currentProductListBean = newProductResponse.getProductlist().get(position);
        switch (v.getId()) {
            ...
            case R.id.tv_buybuybuy://点击事件-->跳转到购物车
                ...
                Log.i(TAG, "添加到购物车" + currentProductListBean.getName());
                //将商品信息添加到数据库
